...
4. Öffne im Pi-hole-Admin *Settings → DNS*. Entferne die Haken bei allen Upstream-Servern und füge `127.0.0.1#5335` als eigenen Upstream-Server hinzu. Speichere.
